...
function debuggedMoves(spot){
  ...
  let trueSpots = [];
  for(let i = 0; i < moves.length; i++){
    if(moves[i].piece == undefined ||
       moves[i].piece.team != spot.piece.team){
...
function preload(){
  ...
  // };
  imgs = {
    bishopW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-bishop.png"),
    rookW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-rook.png"),
    knightW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-knight.png"),
    queenW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-queen.png"),
    kingW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-king.png"),
    pawnW: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/w-pawn.png"),
    
    bishopB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-bishop.png"),
    rookB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-rok.png"),
    knightB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-knight.png"),
    queenB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-queen.png"),
    kingB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-king.png"),
    pawnB: loadImage("https://cdn.jsdelivr.net/gh/Jkutkut/JS_Chess-Game@master/img/chess-pawn.png")
  };
}